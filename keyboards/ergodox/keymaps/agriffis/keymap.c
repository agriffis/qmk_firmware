 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Del  | Grv  |Insert| Left | Right|                                       | Down |  Up  |   [  |   ]  |  L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Ctrl | Alt  |       | Alt  | Ctrl |
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_DEL,   KC_GRV,  KC_INS,  KC_LEFT,  KC_RGHT,
                                               KC_LCTL,KC_LALT,
                                                       KC_HOME,
        ...
        // right hand
             ...
             KC_RGUI,     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,  KC_RSFT,
                                  KC_DOWN,KC_UP,  KC_LBRC,KC_RBRC,  TG(SYMB),
             KC_RALT,KC_RCTL,
             KC_PGUP,
 ...
 *                                        |      |      |       |       |      |
 *                                 ,------|------|------|       |-------+------+------.
 *                                 |Mouse | Play | Prev |       | VolUp | Mute | Mouse|
 *                                 |Left  |      |------|       |-------|      | Right|
 *                                 |Click |      | Next |       | VolDn |      | Click|
 *                                 `--------------------'       `---------------------'
 */
// MEDIA AND MOUSE
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_WBAK, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_MPRV,
                                  KC_BTN1, KC_MPLY, KC_MNXT,
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
