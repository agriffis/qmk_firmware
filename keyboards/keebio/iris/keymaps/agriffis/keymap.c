...
KC_LSFT,  LT(1,KC_Z),  KC_X,     KC_C,      KC_V,     KC_B,     MT(MOD_LGUI,KC_ESC),  MT(MOD_LALT,KC_ENT),  KC_N,     KC_M,     KC_COMM,  KC_DOT,    LT(1,KC_SLSH),  KC_RSFT,
_         _            _         _          KC_LBRC,  KC_BSPC,  MT(MOD_LGUI,KC_ESC),  MT(MOD_LALT,KC_ENT),  KC_SPC,   KC_RBRC   _         _          _               _
...
_______,  KC_GRV,      KC_WBAK,  KC_WFWD,   KC_INS,   XXXXXXX,  KC_LGUI,              KC_LALT,              XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   _______,        _______,
_         _            _         _          XXXXXXX,  KC_DEL,   KC_LGUI,              KC_LALT,              XXXXXXX,  XXXXXXX   _         _          _               _
