...
KC_LSFT,  LT(1,KC_Z),  KC_X,     KC_C,      KC_V,                  KC_B,     KC_ESC,   KC_ENT,   KC_N,     KC_M,                 KC_COMM,  KC_DOT,    LT(1,KC_SLSH),  KC_RSFT,
_         _            _         _          MT(MOD_LGUI,KC_LBRC),  KC_BSPC,  KC_ESC,   KC_ENT,   KC_SPC,   MT(MOD_LALT,KC_RBRC)  _         _          _               _
