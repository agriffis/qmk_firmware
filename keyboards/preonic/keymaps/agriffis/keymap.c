...
MO(1),    KC_GRV,      KC_LALT,  KC_LGUI,   KC_BSPC,  KC_ESC,   KC_ENT,   KC_SPC,   KC_RGUI,  KC_LBRC,   KC_RBRC,        MO(1)
),

[1] = LAYOUT(
KC_HOME,  KC_F1,       KC_F2,    KC_F3,     KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,     KC_F10,         KC_END,
XXXXXXX,  XXXXXXX,     KC_UP,    XXXXXXX,   XXXXXXX,  KC_EXEC,  KC_APP,   KC_RGUI,  KC_SLCK,  KC_PAUS,   KC_PSCR,        KC_PGUP,
...
TT(2),    XXXXXXX,     _______,  _______,   KC_DEL,   XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,   XXXXXXX,        TT(2)
),
...
TG(2),    XXXXXXX,     XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,        TG(2)
)};
